...
{
    public enum AaChoice { None, Msaa, Fxaa, Taa, Dlss, Fsr }
    ...
    public sealed class AaMenuDraft
    {
        ...
        public bool ResolutionEnabled => Choice == AaChoice.Dlss || Choice == AaChoice.Fsr;
        ...
        public AaMenuDraft(AaSettings settings, int nativeMsaa, bool nativeFxaa)
        {
            ...
            Choice = settings.Technique == AaTechnique.Fsr ? AaChoice.Fsr :
                settings.Technique == AaTechnique.Dlss ? AaChoice.Dlss :
        ...
        public bool TrySelectTechnique(AaChoice choice, UpscalerAvailability availability)
        {
        ...
        public void SelectTechnique(AaChoice choice)
        {
            ...
            Choice = choice;
            AaTechnique technique = choice == AaChoice.Fsr ? AaTechnique.Fsr : choice == AaChoice.Dlss ? AaTechnique.Dlss :
                choice == AaChoice.Taa ? AaTechnique.Taa : choice == AaChoice.Fxaa ? AaTechnique.Fxaa : AaTechnique.Original;
            Settings = new AaSettings(technique, Settings.Model, Settings.Resolution, Settings.FsrSharpness);
            UpdateNative();
        }
        public void SelectResolution(ResolutionMode resolution)
        {
            ...
            Settings = new AaSettings(Settings.Technique, Settings.Model, resolution, Settings.FsrSharpness);
        }
        public void SelectConfiguration(int index)
        {
            if (Choice == AaChoice.Dlss)
            {
                ...
                Settings = new AaSettings(Settings.Technique, (ModelSelection)index, Settings.Resolution, Settings.FsrSharpness);
            }
        ...
        private void UpdateNative()
        {
            ...
            NativeFxaa = Choice == AaChoice.Fxaa || Choice == AaChoice.Taa || Choice == AaChoice.Dlss || Choice == AaChoice.Fsr;
        }
    }
}
